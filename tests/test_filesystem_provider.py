...
def make_mp3(
    path: Path, title: str, artist: str, album: str, comment: str, bitrate: str = "128k"
):
...
def test_filesystem_provider_rules(tmp_path, capsys):
    ...
    make_mp3(
        music / "low-bitrate.mp3", "Low Bitrate", "Artist C", "Album C", "S3", "32k"
    )
