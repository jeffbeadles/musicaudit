...
def test_missing_rating_rule_detects_unrated_track():
    lib = make_library([
        {"name": "A", "artist": "X", "album": "Y", "comments": "S5", "bit_rate": 320, "path": None, "kind": "MPEG audio file"},
        {"name": "B", "artist": "X", "album": "Y", "comments": "", "bit_rate": 320, "path": None, "kind": "MPEG audio file"},
    ])
...
def test_low_bitrate_uses_resolved_threshold():
    lib = make_library([
        {"name": "A", "artist": "X", "album": "Y", "comments": "S5", "bit_rate": 64, "path": None, "kind": "MPEG audio file"},
        {"name": "B", "artist": "X", "album": "Y", "comments": "S5", "bit_rate": 320, "path": None, "kind": "MPEG audio file"},
    ])
...
def test_empty_smart_playlist_not_reported_as_empty_standard():
    lib = Library(
        xml_path="test.xml",
        tracks=[],
        playlists=[{"name": "Validate Missing Ratings", "is_smart": True, "folder": False, "item_count": 0}],
        known_tokens={"FAV"},
        config={},
        settings=Settings(),
    )
